...
class EditContactViewController: BaseViewController
{
    ...
    class func createOne() -> EditContactViewController
    {
        let vc: EditContactViewController = self.loadFromStoryboard(storyboardName: Constants.Resources.Storyboards.main)
        return vc
    }
...
extension EditContactViewController: EditPresenterViewProtocol
{
